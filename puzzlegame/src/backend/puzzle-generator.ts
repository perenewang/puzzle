...
export class JigsawGenerator {
    ...
    constructor(options: JigsawGeneratorOptions) {
        ...
        this.seed = this.getSeed(options.seed ?? Math.trunc(Math.random() * Number.MAX_SAFE_INTEGER));
        ...
        this.pushStroke(this.xCount - 1, {
            points: [
                this.round(this.width - this.sw), 0,
        ...
        this.pushStroke(this.xCount * this.yCount - 1, {
            points: [
                this.width, this.round(this.height - this.sw, 3),
        ...
        this.pushStroke(this.xCount * (this.yCount - 1), {
            points: [
                this.round(this.sw, 3), this.height,
    ...
    private l(v: number) {
        return this.round(this.ol + this.sl * v, 3);
    }

    private w(v: number) {
        return this.round(this.ow + this.sw * v * (this.flip ? -1 : 1), 3);
    }
...
const out = new JigsawGenerator({width:300, height:500, xCount:3, yCount:5, radius:20, fixedPattern:false});
